 ...
 * <p>
 * 题解：使用有序表求解，有序表中可以查找到第几小的数，O(logN)级别的，如果窗口大小是奇数，直接找 k /2 的值
 * 如果是偶数，则使用前后两个位置的平均值即可
 *
 * @author oudaming
 * @date 2021-02-03 10:36
 */
public class _480_Sliding_Window_Median {
    ...
    public static void main(String[] args) {
        ...
        int k = 3;
        double[] doubles = new _480_Sliding_Window_Median().medianSlidingWindow(nums, k);
